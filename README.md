# Task 9: More Programming

This repository contains programs created for **Task 9**, demonstrating the use of multiple programming languages and their behavior in an editor.
...
- `editor_comparison.txt` – Comparison of how PHP and Rust appear inside code-oss (syntax highlighting, warnings, extensions, etc.).  
- `php-code-oss.png` – Screenshot of `hello.php` in code-oss.  
- `rust-code-oss.png` – Screenshot of `hello.rs` in code-oss.
